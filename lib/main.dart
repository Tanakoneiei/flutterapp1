    ...
    return Scaffold(
      ...
      body: GridView.count(
        ...
        children: [
          Card(
              context: context,
              color: Color.fromARGB(2255, 186, 131, 97),
              ...
              nickname: "nickname : Kate",
              id: "ID : 633410014-4",
              birthday: "birthday : 27 december 2001"),
          Card(
              context: context,
              color: Color.fromARGB(2255, 186, 131, 97),
              ...
              nickname: "nickname : Jonus",
              id: "ID : 633410009-7",
              birthday: "birthday : 7 march 2001"),
          Card(
              context: context,
              color: Color.fromARGB(2255, 186, 131, 97),
              ...
              nickname: "nickname : Bom",
              id: "ID : 633410013-6",
              birthday: "birthday : 8 july 2001"),
          ...
          Card(
              ...
              nickname: "nickname : Kanun",
              id: "ID : 633410036-4",
              birthday: "birthday : 27 february 2001"),
        ],
      ),
    );
  }
  ...
  Widget Card(
    ...
    return Container(
      ...
      child: GestureDetector(
        ...
        child: Column(
          children: [
            GFAvatar(backgroundImage: NetworkImage(imgPath),shape: GFAvatarShape.standard,size: 100,),
            Container(
    ...
    return Scaffold(
        ...
        body: Center(
          ...
          children: [
            ...
            GFAvatar(backgroundImage: NetworkImage(imPath),shape: GFAvatarShape.standard,size: 100,),
            const Padding(padding: EdgeInsets.all(10)),
            Text(name),
            Text(id),
            Text(nickname),
